...
const bar_second: HTMLElement | null = document.querySelector(".clock__second");
const bar__min: HTMLElement | null = document.querySelector(".clock__min");
const bar__hour: HTMLElement | null = document.querySelector(".clock__hour");
